...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    {!! Form::model($vehicle, ['enctype'=>'multipart/form-data','method' => 'PATCH','route' => ['vehicles.update', $vehicle->id]]) !!}

                    <div class="row" id="dynamic-fields">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('Type', 'Vehicle Type*') !!}
                                {!! Form::text('vehicle_type', null, ['class' => 'form-control', 'placeholder' => 'Enter Vehicle Type']) !!}
