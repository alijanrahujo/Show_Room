                        ...
                        <div class="row" id="dynamic-fields">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('vehicles', $vehicle->vehicle_type, ['class' => 'form-control', 'placeholder' => 'Enter Type']) !!}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('power', $vehicle->horse_power, [
                                        'class' => 'form-control',
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('amount', $vehicle->purchase_price, [
                                        'class' => 'form-control',
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('sale', $vehicle->sale_price, ['class' => 'form-control', 'placeholder' => 'Enter Amount']) !!}
                                    <small id="emailHelp" class="form-text text-muted"></small>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('saletax', $vehicle->sale_tax, [
                                        'class' => 'form-control',
                                        'placeholder' => 'Tax',
                                        'id' => 'saletax',
                                    ]) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::number('registration', $vehicle->reg_fee, [
                                        'class' => 'form-control',
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('status', ['1' => 'Active', '0' => 'Deactive'], $vehicle->status, [
                                        'placeholder' => 'Select',
                                        'class' => 'form-control',
                                        'id' => 'status',
                                    ]) !!}
