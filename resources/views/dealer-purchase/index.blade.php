            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Dealer Purchase</a></li>
                        <li class="breadcrumb-item active">Dealer Purchase list</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title clearfix">
                        <div>
                            <a href="{{Route('dealer-purchase.create')}}" class="btn btn-primary float-right">Purchase Bike</a>
                        </div>
                    </h4>
