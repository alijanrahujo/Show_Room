...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    {!! Form::model($dealer, ['enctype'=>'multipart/form-data','method' => 'PATCH','route' => ['dealers.update', $dealer->id]]) !!}

                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('company', 'Company Name *') !!}
                                {!! Form::text('company_name', null, ['class' => 'form-control', 'id' => 'company', 'placeholder' => 'Company Name']) !!}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('dealer_name', null, ['class' => 'form-control', 'id' => 'dealer', 'placeholder' => 'Dealer Name']) !!}
                                <small id="emailHelp" class="form-text text-muted"></small>
                            </div>
                        </div>
                    </div>
