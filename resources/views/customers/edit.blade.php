...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    {!! Form::model($customer, ['enctype'=>'multipart/form-data','method' => 'PATCH','route' => ['customers.update', $customer->id]]) !!}

                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('customer', 'Customer Name *') !!}
                                {!! Form::text('customer_name', null, ['class' => 'form-control', 'id' => 'customer', 'placeholder' => 'Customer Name']) !!}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('father_name', null, ['class' => 'form-control', 'id' => 'father', 'placeholder' => 'Father Name']) !!}
                                <small id="emailHelp" class="form-text text-muted"></small>
                            </div>
                        </div>
                    </div>
