                ...
                <div class="page-title-box">
                    <div class="float-right">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Used Bikes</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title clearfix">
                            <div>
                                <a href="{{ Route('purchases.create') }}" class="btn btn-primary float-right">Purchase
                                    Bike</a>
                            </div>
                        </h4>
