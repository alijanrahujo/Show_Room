                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="general_detail_tab" data-toggle="pill" href="#general_detail">Sale Detail</a></li>
                                <li class="nav-item"><a class="nav-link" id="activity_detail_tab" data-toggle="pill" href="#activity_detail">Customer Detail</a></li>
                                                ...
                                                <div class="tab-pane fade show active" id="files-pdf">
                                                    ...
                                                    <div class="file-box-content">
                                                        <table class="table table-striped-columns">
                                                            <tr class="h5">
                                                                <th>Title</th>
                                                                <td>{{$sale->title??'Not Available'}}</td>
                                                            </tr>
                                                            <tr class="h5">
                                                                <th>Engine</th>
                                                                <td>{{$sale->engine??'Not Available'}}</td>
                                                            </tr>
                                                            <tr class="h5">
                                                                <th>Chassis </th>
                                                                <td>{{$sale->chassis??'Not Available'}}</td>
                                                            </tr>
                                                            <tr class="h5">
                                                                <th>Color </th>
                                                                <td>{{$sale->color??'Not Available'}}</td>
                                                            </tr>
                                                            <tr class="h5">
                                                                <th>Model</th>
                                                                <td>{{$sale->model??'Not Available'}}</td>
                                                            </tr>
                                                            <tr class="h5">
                                                                <th>Purchase Amount</th>
                                                                <td>{{$sale->payment->purchase_amount ?? 0}}</td>
                                                            </tr>
                                                            <tr class="h5">
                                                                <th>Sale Amount</th>
                                                                <td>{{$sale->payment->sale_amount ?? 0}}</td>
                                                            </tr>
                                                            <tr class="h5">
                                                                <th>Profit Amount </th>
                                                ...
                                                <div class="tab-pane fade show active" id="files-pdf">
                                                    ...
                                                    <div class="file-box-content">
                                                        <table class="table table-striped-columns">
                                                            <tr class="h5">
                                                                <th>Customer Name</th>
                                                                <td>{{$sale->customer->customer_name??'Not Available'}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>Customer Phone</th>
                                                                <td>{{$sale->customer->phone??'Not Available'}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>Customer Cnic</th>
                                                                <td>{{$sale->customer->cnic??'Not Available'}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>Address</th>
                                                                <td>{{$sale->customer->address??'Not Available'}}</td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                                </div><!--end tab-pane-->
