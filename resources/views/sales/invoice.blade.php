                ...
                <div class="invoice-head">
                    ...
                    <div class="invoice-head-middle text-bold">
                        <div class="invoice-head-middle-left text-start">
                            ...
                            <p><span>Date:</span> {{ $sale->sale->date }}</p>
                            <p><span>Name:</span> {{ $sale->sale->customer->customer_name }}</p>
                            <p><span>Address:</span> {{ $sale->sale->customer->address }}</p>
                        </div>
                    </div>
                        ...
                        <table cellspacing='0' class="text-bold">
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td rowspan="6">{{ $sale->sale_price }}</td>
                                    <td rowspan="6">{{ $sale->sale_tax }}%</td>
                                    <td rowspan="6">{{ ($sale->sale_price / 100) * $sale->sale_tax }}</td>
                                    <td rowspan="6">
                                        {{ $sale->sale_price + ($sale->sale_price / 100) * $sale->sale_tax }}
                                    </td>
                                </tr>
                                <tr>
